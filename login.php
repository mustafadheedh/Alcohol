...
<html lang="en">
    ...
    <div class="hero-wrap" style="background-image: url('images/bg_2.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-8 ftco-animate d-flex align-items-end" style="justify-content:center;">
          	<div class="card" style="border:1px solid white; width:600px; height:500px;">
            ...
            <br><br>
                ...
                <br><br>
              <button type="submit" style="background-color:black; color:white;" name="loginbtn">Submit</button>
              </form>
            </div>
  ...
  if(isset($_POST["loginbtn"]))
  {
    ...
    $insertquery ="select * from usertbl where email='".$useremail."' and password='".$userpassword."'";
    $insertqueryconnect = mysqli_query($con,$insertquery);
    $count = mysqli_num_rows($insertqueryconnect);
    if($count>0)
    {
        $checkrole = mysqli_fetch_array($insertqueryconnect);
        if($checkrole['role']==0)
        {
            header("Location:index.php");

        }
        else if($checkrole['role']==1)
        {
