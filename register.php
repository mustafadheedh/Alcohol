...
<html lang="en">
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-8 ftco-animate d-flex align-items-end" style="justify-content:center;">
            ...
            <br><br>
                ...
                <br><br>
              <button type="submit" style="background-color:black; color:white;" name="submitbtn">Submit</button>
              </form>
            </div>
  ...
  if(isset($_POST["submitbtn"]))
  {
    ...
    $insertquery ="insert into usertbl (name,email,password,role) values('".$username."','".$useremail."','".$userpassword."','0')";
